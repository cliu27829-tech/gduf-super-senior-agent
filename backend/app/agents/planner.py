...
INTENT_TOOLS = {
    ...
    "knowledge_import": ["import_local_documents"],
...
class Planner:
    def build(self, decision: IntentDecision) -> AgentPlan:
        ...
        confirmation = decision.intent in {"notification_to_tasks", "document_analysis", "knowledge_import", "data_feedback"}
        ...
        return AgentPlan(
            ...
            tool_names=tools,
            requires_knowledge=decision.intent in {"campus_process", "knowledge_search"},
